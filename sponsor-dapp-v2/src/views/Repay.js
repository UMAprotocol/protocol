								...
								<div className="popup__body-step">
									<div className="popup__col">
										<div className="popup__entry popup__entry-alt">
											<p>You must authorize your facility to redeem your tokens in exchange for DAI held in the smart contract. This is standard across ERC-20 contracts and you will only have to do this once.</p>
										</div>
										...
										<div className="popup__actions">
											<a href="test"
												className={classNames(
													...
													{'is-loading': this.state.isLoadingInfo})
												}
