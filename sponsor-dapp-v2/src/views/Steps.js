				...
				<div className="steps__inner">
					<div className="shell">
								...
								{this.state.steps.map((item, index) => {
									return (
										...
										>
											...
											<span className="icon">
												<IconSvgComponent
													iconPath="svg/ico-check.svg"
													additionalClass="ico-check"
												/>
											</span>
										</li>
									);
						...
						<div className="steps__body">
							<CSSTransition
								in={this.state.activeStepIndex === 0}
								timeout={300}
								classNames="step-1"
								unmountOnExit
							>
							...
							<CSSTransition
								in={this.state.activeStepIndex === 1}
								timeout={300}
								classNames="step-2"
								unmountOnExit
							>
							...
							<CSSTransition
								in={this.state.activeStepIndex === 2}
								timeout={200}
								classNames="step-3"
								unmountOnExit
							>
							...
							<CSSTransition
								in={this.state.activeStepIndex === 3}
								timeout={200}
								classNames="step-4"
								unmountOnExit
							>
							...
							<CSSTransition
								in={this.state.activeStepIndex === 4}
								timeout={300}
								classNames="step-5"
								unmountOnExit
							>
							...
							<CSSTransition
								in={this.state.activeStepIndex === 5}
								timeout={300}
								classNames="step-6"
								unmountOnExit
							>
