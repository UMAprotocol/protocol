                  ...
                  <div className="section__status">
                    ...
                    <div className="indicator">
                      <span
                        className="icon"
                        style={{
                          backgroundColor: `${managePosition.contractStatus.statusColor}`
                        }}
                      />
                      {managePosition.contractStatus.statusText}
                    </div>
                  </div>
                </div>
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <strong>{managePosition.assets[0].items.value}</strong>
                            </td>
                          </tr>
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <strong>
                                {managePosition.collateral[0].items.amount.absolute} DAI (
                                {managePosition.collateral[0].items.amount.percentage}%)
                              </strong>
                            </td>

                            <td>
                              <strong>
                                (min. {managePosition.collateral[0].items.liquidation} needed to avoid liquidation)
                              </strong>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <strong>
                                (min. {managePosition.collateral[2].items.liquidation} DAI needed to avoid liquidation)
                              </strong>
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <strong>{managePosition.tokens[0].items.amount.absolute} Tokens</strong>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <strong>
                                {managePosition.tokens[1].items.amount.absolute} (
                                {managePosition.tokens[1].items.amount.percentage}%)
                              </strong>
                            </td>

                            <td>
                              <strong>({managePosition.tokens[1].items.value} DAI)</strong>
                            </td>
                          </tr>
                        </tbody>
                      </table>
