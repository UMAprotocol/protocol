			...
			<div className="step">
				<div className="step__content">
					<p>
						...
						<span>
							(address:{' '}
							{data.tokenFacilityAddress.display.slice(0, 2)}
							.....)
						</span>
					</p>
					...
					<p>
						<span>
							In order to fund and borrow your tokens, you must
							authorize your new facility to accept DAI as the
							collateral. This is standard acrossERC-20 contracts
