...
contract("TokenizedDerivative", function(accounts) {
  ...
  before(async function() {
    productBytes = web3.utils.hexToBytes(web3.utils.utf8ToHex("ETH/USD"));
    ...
    await deployedCentralizedOracle.addSupportedProduct(productBytes);
    await deployedManualPriceFeed.pushLatestPrice(productBytes, 100, web3.utils.toWei("1", "ether"));
