...
contract('Derivative', function(accounts) {
  ...
  beforeEach((done) => {
       Registry.deployed().then(function(instance) {
        ...
        return deployedRegistry.createDerivative(accounts[1], deployedOracle.address, web3.toWei('0.05', 'ether'), web3.toWei('0.1', 'ether'), (date.valueOf() / 1000).toString(), 'ETH/USD', web3.toWei('1', 'ether'), {from: accounts[0], value: web3.toWei('1', 'ether')});
