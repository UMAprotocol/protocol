...
yarn hardhat run ./packages/scripts/src/upgrade-tests/across-v3-update/0_Deploy.ts --network localhost

ORIGIN_VALIDATOR_ADDRESS=<ADDRESS-FROM-PREVIOUS-SCRIPT> yarn hardhat run ./packages/scripts/src/upgrade-tests/across-v3-update/1_Propose.ts --network localhost
...
yarn hardhat run ./packages/scripts/src/upgrade-tests/across-v3-update/2_Verify.ts --network localhost
```
