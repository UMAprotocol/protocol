...
import { IdentifierWhitelist, Registry } from "@uma/contracts-node/dist/packages/contracts-node/typechain/core/ethers";
...
const getConnectedRegistry = async (chainId: number): Promise<Registry> =>
  getContractInstanceWithProvider<Registry>("Registry", getRetryProvider(chainId));
