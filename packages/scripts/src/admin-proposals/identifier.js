...
// - Verify: node ./packages/scripts/admin-proposals/identifier.js --verify --polygon 0xabc,0x123 --identifier 0xabc,0x123 --network mainnet-fork
...
//    - `node ./packages/scripts/admin-proposals/identifier.js --identifier "POOL/USD","USD/POOL" --network mainnet-fork`
// - Whitelist identifiers on Polygon only:
//    - `node ./packages/scripts/admin-proposals/identifier.js --polygon "POOL/USD","USD/POOL" --network mainnet-fork`
// - Whitelist identifiers on both (some on Ethereum, some on Polygon):
//    - `node ./packages/scripts/admin-proposals/identifier.js --identifier "POOL/USD","USD/POOL" --polygon "POOL/USD", --network mainnet-fork`
