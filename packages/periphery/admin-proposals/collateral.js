...
// - Verify: node ./packages/periphery/admin-proposals/collateral.js --verify --collateral 0xabc,0x123 --fee 0.1,0.2 --polygon 0xdef,0x456 --network mainnet-fork
...
//    - `node ./packages/periphery/admin-proposals/collateral.js --collateral 0xabc,0x123 --network mainnet-fork`
// - Whitelist collateral on Polygon only:
//    - `node ./packages/periphery/admin-proposals/collateral.js --polygon 0xabc,0x123 --network mainnet-fork`
// - Whitelist collateral on both (some on Ethereum, some on Polygon):
//    - `node ./packages/periphery/admin-proposals/collateral.js --collateral 0xabc,0x123 --polygon 0xdef, --network mainnet-fork`
