...
// - Verify: node ./packages/periphery/admin-proposals/registerContract.js --verify --ethereum 0xabc --polygon 0xdef --network mainnet-fork
...
//    - `node ./packages/periphery/admin-proposals/registerContract.js --ethereum 0xabc --network mainnet-fork`
// - Register contract on Polygon only:
//    - `node ./packages/periphery/admin-proposals/registerContract.js --polygon 0xabc --network mainnet-fork`
// - Register contract on both:
//    - `node ./packages/periphery/admin-proposals/registerContract.js --ethereum 0xabc --polygon 0xdef --network mainnet-fork`
