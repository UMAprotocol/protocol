...
// - Next, open another terminal window and run `./packages/periphery/setup.sh` to unlock
...
// - Execute proposal 10:
//   node ./packages/periphery/admin-proposals/executeProposal.js --id 10 --network mainnet-fork
