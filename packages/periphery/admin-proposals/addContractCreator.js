...
// - Propose: node ./packages/periphery/admin-proposals/addContractCreator.js --ethereum 0xabc --polygon 0xdef --network mainnet-fork
// - Vote Simulate: node ./packages/periphery/admin-proposals/simulateVote.js --network mainnet-fork
// - Verify: node ./packages/periphery/admin-proposals/addContractCreator.js --verify --ethereum 0xabc --polygon 0xdef --network mainnet-fork
...
//    - `node ./packages/periphery/admin-proposals/addContractCreator.js --ethereum 0xabc --network mainnet-fork`
// - Add contract creator on Polygon only:
//    - `node ./packages/periphery/admin-proposals/addContractCreator.js --polygon 0xabc --network mainnet-fork`
// - Add contract creator on both:
//    - `node ./packages/periphery/admin-proposals/addContractCreator.js --ethereum 0xabc --polygon 0xdef --network mainnet-fork`
