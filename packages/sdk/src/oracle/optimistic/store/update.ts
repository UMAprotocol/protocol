import { InputRequest, OptimisticOracleEvent, State } from "../types/state";
import { optimisticOracle } from "../../../clients";

import { OptimisticOracle } from "../../common/services/optimisticOracle";
import { TransactionReceipt } from "../../common/types/ethers";
import { interfaces } from "../../common/types";

import { Store } from "./store";

export class Update implements interfaces.Update {
  private read: Store["read"];
  private write: Store["write"];
  constructor(private store: interfaces.Store<State, OptimisticOracle, OptimisticOracleEvent>) {
