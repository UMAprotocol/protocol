...
export function getFlags<O, E>(read: interfaces.Read<O, E>): Record<Flag, boolean> {
...
export const DefaultConfig = (getters: AddressGetters) => (config: PartialConfig): Config => {
