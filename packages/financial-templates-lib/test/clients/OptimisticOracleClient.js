...
describe("OptimisticOracleClient.js", function () {
  ...
  describe("V1 OptimisticOracle contract", function () {
    beforeEach(async function () {
      optimisticOracle = await V1OptimisticOracle.new(liveness, finder.options.address, timer.options.address).send({
        from: accounts[0],
      });
      client = new OptimisticOracleClient(
        winston.createLogger({ level: "debug", transports: [new SpyTransport({ level: "debug" }, { spy: spy })] }),
