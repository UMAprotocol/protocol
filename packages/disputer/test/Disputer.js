  ...
  describe("18 decimal collateral", function() {
    ...
    beforeEach(async function() {
      ...
      spyLogger = winston.createLogger({
        level: "info",
        transports: [new SpyTransport({ level: "info" }, { spy: spy }), new winston.transports.Console()]
      });
    ...
    it("Detect disputable withdraws and send disputes", async function() {
      ...
      await emp.createLiquidation(
        sponsor1,
        { rawValue: "0" },
        { rawValue: convert("1.75") }, // Price high enough to initiate the liquidation
  ...
  describe("8 decimal collateral", function() {
    ...
    beforeEach(async function() {
      ...
      const constructorParams = {
        ...
        finderAddress: Finder.address,
        tokenFactoryAddress: TokenFactory.address,
        priceFeedIdentifier: utf8ToHex("BTCTEST"),
    ...
    it("Detect disputable withdraws and send disputes", async function() {
      ...
      // at a price of 1.
      const liquidationTime = await emp.getCurrentTime();
      await mockOracle.pushPrice(web3.utils.utf8ToHex("BTCTEST"), liquidationTime, convert("1"));
