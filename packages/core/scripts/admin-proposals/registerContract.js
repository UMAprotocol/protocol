...
// - Propose: node ./packages/core/scripts/admin-proposals/registerContract.js --ethereum 0xabc --polygon 0xdef --network mainnet-fork
// - Vote Simulate: node ./packages/core/scripts/admin-proposals/simulateVote.js --network mainnet-fork
// - Verify: node ./packages/core/scripts/admin-proposals/registerContract.js --verify --ethereum 0xabc --polygon 0xdef --network mainnet-fork
...
//    - `node ./packages/core/scripts/admin-proposals/registerContract.js --ethereum 0xabc --network mainnet-fork`
// - Register contract on Polygon only:
//    - `node ./packages/core/scripts/admin-proposals/registerContract.js --polygon 0xabc --network mainnet-fork`
// - Register contract on both:
//    - `node ./packages/core/scripts/admin-proposals/registerContract.js --ethereum 0xabc --polygon 0xdef --network mainnet-fork`
