...
contract("PricelessPositionManager", function(accounts) {
  ...
  it("Custom price identifier transformation with a financial product library", async function() {
  ...
  it("Correctly handles reverting identifier transformations from financial product library", async function() {
