...
const deployMintableBurnableTokenFactory = require("../migrations/18_deploy_mintable_burnable_token_factory");
...
module.exports = async ({ network, web3 }) => {
  ...
  await deployMintableBurnableTokenFactory(null, network.name, accounts);
