...
contract OVM_BridgeDepositBox is OVM_CrossDomainEnabled, OVM_Testable {
     ...
     *      for L1 Utilization at any time before this timestamp.
     */
    function deposit(
        address recipient,
        address l2Token,
        ...
        // corresponds to the L1 timestamp of the last confirmed L1 ⇒ L2 transaction. If five minutes have  passed since
        // the last L1 ⇒ L2 transaction, the timestamp is automatically refreshed.
