...
library VoteTimingV2 {
     ...
     * The consequence is that the initial round ID starts at an arbitrary number (that increments, as expected, for 
     * subsequent rounds) instead of zero or one.
     p* @param data input data object.
