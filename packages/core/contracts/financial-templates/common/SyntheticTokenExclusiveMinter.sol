...
import "../../common/implementation/ExpandedERC20ExclusiveMinter.sol";
import "../../common/implementation/Lockable.sol";


/**
 * @title Burnable and mintable ERC20 with only one minter allowed.
 * @dev The contract deployer will initially be the only minter, burner and owner capable of adding new roles.
 */

contract SyntheticTokenExclusiveMinter is ExpandedERC20ExclusiveMinter, Lockable {
    /**
     * @notice Constructs the SyntheticTokenExclusiveMinter.
    ...
    constructor(
        ...
        uint8 tokenDecimals
    ) public ExpandedERC20ExclusiveMinter(tokenName, tokenSymbol, tokenDecimals) nonReentrant() {}
