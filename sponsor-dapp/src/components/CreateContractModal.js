...
class CreateContractModal extends React.Component {
  ...
  submit = () => {
    ...
    const constructorParams = {
      ...
      supportedMove: web3.utils.toWei(params.identifiers[formInputs.identifier].dappConfig.supportedMove, "ether"),
      ...
      expiry: params.identifiers[formInputs.identifier].dappConfig.expiry,
