...
contract("TokenizedDerivative", function(accounts) {
  ...
  before(async function() {
    ...
    marginToken = await ERC20Mintable.new("COLLATERAL_TOKEN", "UMA", "18", { from: sponsor });
  ...
  testVariants.forEach(testVariant => {
    ...
    it(annotateTitle("Constructor assertions"), async function() {
      ...
      const unapprovedCurrency = await ERC20Mintable.new("COLLATERAL_TOKEN", "UMA", "18", { from: sponsor });
