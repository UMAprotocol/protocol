docker run -it --env MNEMONIC="saddle invest fever fruit broccoli foam man detail someone client offer pool" \
    ...
    --env SLACK_WEBHOOK="https://hooks.slack.com/services/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" \
    ...
    --env UNISWAP_PRICE_FEED_CONFIG='{"type":"medianizer","apiKey":"IMUDH14WH6E3ROS8AKBX","pair":"ethbtc","lookback":7200,"minTimeBetweenUpdates":60,"medianizedFeeds":[{"type":"cryptowatch","exchange":"coinbase-pro"},{"type":"cryptowatch","exchange":"binance"},{"type":"cryptowatch","exchange":"bitstamp"}]}' \
    --env MEDIANIZER_PRICE_FEED_CONFIG='{"type":"medianizer","apiKey":"IMUDH14WH6E3ROS8AKBX","pair":"ethbtc","lookback":7200,"minTimeBetweenUpdates":60,"medianizedFeeds":[{"type":"cryptowatch","exchange":"coinbase-pro"},{"type":"cryptowatch","exchange":"binance"},{"type":"cryptowatch","exchange":"bitstamp"}]}' \
    --env SYNTHETIC_PEG_MONITOR_OBJECT='{"deviationAlertThreshold":200000000000000000}' \
